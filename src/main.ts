...
export async function run() {
  try {
    ...
    const ignoreCommitKeywordsString = core.getInput('ignore-commit-keywords', { required: false });
    const ignoreCommitKeywords = ignoreCommitKeywordsString ? ignoreCommitKeywordsString.split(',') : [];
